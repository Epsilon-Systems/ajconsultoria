...
/**
 * Strings for component 'moodle', language 'es', version '4.0'.
 *
 * @package     moodle
 * @category    string
...
$string['opendrawerblocks'] = 'Abrir caja del bloque';
$string['opendrawerindex'] = 'Abrir cajón de índice del curso';
...
$string['welcomeback'] = '¡Bienvenido de nuevo, {$a->firstname}! 👋';
