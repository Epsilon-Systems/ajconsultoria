...
/**
 * Strings for component 'admin', language 'es', version '4.0'.
 *
 * @package     admin
 * @category    string
...
$string['xmlrpcmnetauthenticationenabled'] = 'Se ha detectado que la autenticación MNet está habilitada en su sitio. Esta función se basa en la extensión PHP XML-RPC que PHP ya no mantiene.';
